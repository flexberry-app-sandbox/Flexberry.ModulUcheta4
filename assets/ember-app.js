...
define('ember-app/enums/i-i-s-modul-ucheta-\u0443\u0441\u043B\u0443\u0433\u0430', ['exports', 'ember-flexberry-data/utils/enum-functions'], function (exports, _enumFunctions) {
  ...
  exports.default = (0, _enumFunctions.createEnum)({
    РешУстВопр: 'Решение устных вопросов',
    ПомЗакрМес: 'Помощь в закрытии месяца',
    ПомПровДок: 'Помощь в продвижении документа'
  });
});
...
define('ember-app/mixins/regenerated/models/i-i-s-modul-ucheta-\u043E\u043A\u0430\u0437\u0430\u043D\u043D\u044B\u0435-\u0443\u0441\u043B\u0443\u0433\u0438', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('ОказанныеУслугиE', 'i-i-s-modul-ucheta-оказанные-услуги', {
      дата: (0, _attributes.attr)('Дата', { index: 0 }),
      услуги: (0, _attributes.belongsTo)('i-i-s-modul-ucheta-услуги', 'Наименование', {
  ...
  exports.default = _offlineGlobals.default.extend({
    ...
    getOfflineSchema: function getOfflineSchema() {
      ...
      var returnedSchema = Ember.merge(parentSchema, {
        ...
        'i-i-s-modul-ucheta-оказанные-услуги': 'id,дата,услуги,расчетВремени',
